...
namespace MagicVilla_Web.Controllers
{
    public class VillaNumberController : Controller
    {
        ...
        public async Task<IActionResult> IndexVillaNumber()
        {
            ...
            var response = await _villaNumberService.GetAll<APIResponse>(HttpContext.Session.GetString(SD.SessionToken));
        ...
        public async Task<IActionResult> UpdateVillaNumber(int villaNo)
        {
            ...
            var response = await _villaNumberService.Get<APIResponse>(villaNo, HttpContext.Session.GetString(SD.SessionToken));
            if (response != null && response.IsSuccess)
            {
